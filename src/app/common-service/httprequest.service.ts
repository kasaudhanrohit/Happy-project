...
export class HttprequestService {
  ...
  //private apiUrl = 'https://nodejs-project-io61.onrender.com/api';
  ...
  admindetailuserorderstatus(item: any): Observable<any> {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.http.post<any>(`${this.apiUrl}/admindetailuserorderstatus`,item, { headers });
  }
  adminuserorderstatus(item: any): Observable<any> {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.http.post<any>(`${this.apiUrl}/adminuserorderstatus`,item, { headers });
  }

  adminupdateorderstatus(item: any): Observable<any> {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.http.post<any>(`${this.apiUrl}/adminupdateorderstatus`,item, { headers });
  }
